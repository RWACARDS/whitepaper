...
- Escape dollar signs as \$ whenever a single line or paragraph carries two or more plain (unbolded) amounts - bare $...$ pairs are parsed as LaTeX math and mangle the text. Amounts inside bold spans or separate table cells are safe.
- Mermaid diagrams must carry the grayscale init block (base theme, white nodes #ffffff, black text #0a0a0a, gray lines #8c8c8c) to stay black and white.
